...
//
//     final listPengeluaranModel = listPengeluaranModelFromJson(jsonString);

import 'dart:convert';

ListPengeluaranModel listPengeluaranModelFromJson(String str) => ListPengeluaranModel.fromJson(json.decode(str));

class ListPengeluaranModel {
  ListPengeluaranModel({
    this.message,
    this.results,
    this.code,
  });
  ...
  factory ListPengeluaranModel.fromJson(Map<String, dynamic> json) => ListPengeluaranModel(
